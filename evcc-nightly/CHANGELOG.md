...
* chore: deploy OpenAPI spec to docs public folder (#33392)
* EEBus: fix ship-go connection backoff reset (#33384)
* Oprimizer: align battery forecast times to slot boundaries (#33385)
* chore: test loadpoint settings restore (#33382)
* chore: move db package out of server (#33380)
* UI: add missing German date format translations (#33347)
* chore: use official vite+ image for docker UI build (#33373)
* Viessmann: add power and temperature (#32219)
* Smart-hello: retry once with a fresh login when the api rejects the token (#33369)
* Charger (Stiebel Eltron WPM): optional inverter power (#33367)
* Bump docker/metadata-action from 6.1.0 to 6.2.0 (#33363)
* Bump github/codeql-action from 4.37.3 to 4.37.9 (#33362)
* Bump actions/github-script from 8 to 9 (#33361)
* Bump anthropics/claude-code-action from 1.0.178 to 1.0.210 (#33360)
* Bump docker/build-push-action from 7.2.0 to 7.3.0 (#33358)
* chore: fix MyŠkoda sandbox bool comparison (#33364)
* Templates: pass bool params as real booleans (#33153)
* Keep access and refresh tokens out of the logs (#33339)
* Charts: consistent y-axis unit scaling for small values (#33334)
