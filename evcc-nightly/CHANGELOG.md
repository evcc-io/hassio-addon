...
* docs: fix openWB native charger doc (firefox-esr, example user) (#31936)
* chore: skip uncached warning on cache hits (#31934)
* chore: cache http requests (#31933)
* HTTP plugin: warn on uncached repeated GET requests (#31932)
* Revert "loadpoint: fix phase detection for low current" (#31931)
* chore: fix phase detection for low current (#31930)
