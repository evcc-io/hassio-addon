...
>[!IMPORTANT]
>
> The directory structure of the Add-On will change!
...
>
> You have to change your file folder or your add on configuration. /config/evcc.yaml will be /homeassistant/evcc.yaml
>
