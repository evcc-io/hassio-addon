...
* Translations update from Hosted Weblate (#32952)
...
* chore: update npm dependencies (#33172)
...
* chore: expand GOROOT lazily in Makefile (#33143)
* chore: fix vite+ bin PATH (#33142)
